...
DOCKER_IMAGE ?= brazil-ddd-codes-anki-workbench
...
help:
	...
	@printf "  make apkg   Build the Anki package\n"
...
apkg:
	$(UV) run --extra deck python scripts/fetch_map_assets.py
	$(UV) run --extra deck python scripts/generate_maps.py
